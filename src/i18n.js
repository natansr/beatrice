const messages = {
  'pt-BR': {
    ...
    processHelp: 'Criar uma cópia em escala de cinza e com contraste. O original é preservado.',
  ...
  'en-US': {
    ...
    processHelp: 'Create a grayscale copy with adjusted contrast. The original is preserved.',
