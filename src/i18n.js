const messages = {
  'pt-BR': {
    ...
    processImage: 'Processar imagem', runOcr: 'Reconhecer texto (OCR)', ocrTitle: 'Converter o texto da imagem em texto editável.', markReview: 'Marcar para revisão', markReviewed: 'Marcar revisada', transcriptionPlaceholder: 'Texto da página',
    processHelp: 'Corrigir sombras e contraste da fotografia. O original é preservado.',
    processing: 'Processando…', preparingImage: 'Corrigindo sombras e contraste…', imageProcessed: 'Imagem processada sem alterar o original.', ocrFailed: 'OCR falhou: {message}', ocrConfidence: 'Confiança OCR: {value}%',
  ...
  'en-US': {
    ...
    processImage: 'Process image', runOcr: 'Recognize text (OCR)', ocrTitle: 'Convert text in the image into editable text.', markReview: 'Mark as needs review', markReviewed: 'Mark as reviewed', transcriptionPlaceholder: 'Page text',
    processHelp: 'Correct shadows and contrast in the photograph. The original is preserved.',
    processing: 'Processing…', preparingImage: 'Correcting shadows and contrast…', imageProcessed: 'Image processed without changing the original.', ocrFailed: 'OCR failed: {message}', ocrConfidence: 'OCR confidence: {value}%',
